...
<<<<<<< HEAD:pose-detection/src/blazepose/blazepose_test.ts
...
const MODEL_CONFIG: BlazePoseTfjsModelConfig = {
  runtime: 'tfjs',
  lite: true,
};

>>>>>>> 62fa971 ([pose-detection]Refactor ModelConfig and EstimationConfig. (#702)):pose-detection/src/blazepose_tfjs/blazepose_test.ts
// ref:
...
=======
        poseDetection.SupportedModels.BlazePose, MODEL_CONFIG);
>>>>>>> 62fa971 ([pose-detection]Refactor ModelConfig and EstimationConfig. (#702)):pose-detection/src/blazepose_tfjs/blazepose_test.ts
  });
