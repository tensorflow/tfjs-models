...
import {SelfieSegmentationModelConfig, SelfieSegmentationSegmentationConfig} from '../selfie_segmentation_mediapipe/types';

/**
 * Model parameters for SelfieSegmentation TFJS runtime.
 *
 ...
 *
 */
export interface SelfieSegmentationTfjsModelConfig extends
...
/**
 * Body segmentation parameters for SelfieSegmentation TFJS runtime.
 */
export interface SelfieSegmentationTfjsSegmentationConfig extends
