...
//       ],
//       bottomRight: [
//         imageWidth - 1 - (face.boundingBox.bottomRight as [number,
//         number])[0], (face.boundingBox.bottomRight as [number, number])[1]
//       ]
//     },
...
//   await faceMesh.load(
//       meshWidth, meshHeight, maxContinuousChecks, detectionConfidence,
//       maxFaces, iouThreshold, scoreThreshold);
//   return faceMesh;
// }
...
//         blazeFace, blazeMeshModel, meshWidth, meshHeight,
...
//   loadFaceModel(maxFaces: number, iouThreshold: number, scoreThreshold:
//   number):
...
//     tf.env().set('WEBGL_PACK_DEPTHWISECONV',
//     savedWebglPackDepthwiseConvFlag);
...
//         if (flipHorizontal) {
//           annotatedPrediction = flipFaceHorizontal(annotatedPrediction,
//           width);
//         }
