...
// import {Box, createBox, cutBoxFromImageAndResize, enlargeBox, getBoxSize,
// scaleBoxCoordinates} from './box';
...
//               false   // whether to annotate facial bounding boxes with
//               landmark
//                       // information
//           );
...
//       const scaledCoords = tf.mul(coordsReshaped, [
//                                ...normalizedBoxSize, 1
//                              ]).add([...box.startPoint, 0]);
...
//             box.startPoint.concat(box.endPoint);
//         const [prevStartX, prevStartY, prevEndX, prevEndY] =
//             previousBox.startPoint.concat(previousBox.endPoint);
